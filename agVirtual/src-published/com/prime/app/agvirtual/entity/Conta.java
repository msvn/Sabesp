...
public class Conta implements Serializable {
	...
	private ArrayList listaRgisFilhosContaRolEspecial;
	
	/**
	 * Atributos utilizados no controle de rendere na tela de impressao2via rol comum 
	 */
	private boolean renderedMulta;
	private boolean renderedAtualizacaoMonetaria;
	private boolean renderedJurosMora;
	private boolean renderedDebito;
	private boolean renderedCredito;
	private boolean renderedServico;
	private boolean renderedRetencao;
	
	
	public boolean isRenderedMulta() {
		return renderedMulta;
	}

	public void setRenderedMulta(boolean renderedMulta) {
		this.renderedMulta = renderedMulta;
	}

	public boolean isRenderedAtualizacaoMonetaria() {
		return renderedAtualizacaoMonetaria;
	}

	public void setRenderedAtualizacaoMonetaria(boolean renderedAtualizacaoMonetaria) {
		this.renderedAtualizacaoMonetaria = renderedAtualizacaoMonetaria;
	}

	public boolean isRenderedJurosMora() {
		return renderedJurosMora;
	}

	public void setRenderedJurosMora(boolean renderedJurosMora) {
		this.renderedJurosMora = renderedJurosMora;
	}

	public boolean isRenderedDebito() {
		return renderedDebito;
	}

	public void setRenderedDebito(boolean renderedDebito) {
		this.renderedDebito = renderedDebito;
	}

	public boolean isRenderedCredito() {
		return renderedCredito;
	}

	public void setRenderedCredito(boolean renderedCredito) {
		this.renderedCredito = renderedCredito;
	}
	...
	public boolean isRenderedRetencao() {
		return renderedRetencao;
	}

	public void setRenderedRetencao(boolean renderedRetencao) {
		this.renderedRetencao = renderedRetencao;
	}


	public ArrayList getListaRgisFilhosContaRolEspecial() {
		return listaRgisFilhosContaRolEspecial;
	}

	public void setListaRgisFilhosContaRolEspecial(
			ArrayList listaRgisFilhosContaRolEspecial) {
	...
	public String getVlTotalAux() {
		return WrapperUtils.parseMoney(vlTotal.toString());
	}

	public void setVlTotalAux(String vlTotalAux) {
		this.vlTotalAux = vlTotalAux;
	}	
