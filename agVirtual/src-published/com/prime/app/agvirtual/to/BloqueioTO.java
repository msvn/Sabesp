...
import com.prime.app.agvirtual.util.DateUtil;
...
public class BloqueioTO implements BasicTO<AgvTabBloqueio>{
	...
	public AgvTabBloqueio toEntity() {
		...
		tabBloqueio.setDsMensagem(descricao);
...
//		tabBloqueio.setExcluido(excluido);
		...
		try {
			tabBloqueio.setDtInclusao(DateUtil.format.parse(dataBloqueio));
		} catch (ParseException e) {
		}
		tabBloqueio.setNmBloqueio(nmBloqueio);
