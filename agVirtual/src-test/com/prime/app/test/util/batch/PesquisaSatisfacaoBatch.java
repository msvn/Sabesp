...
import com.prime.app.agvirtual.entity.batch.PesquisaSatisfacao;
import com.prime.app.test.util.BatchTools;

public class PesquisaSatisfacaoBatch extends BatchTools<PesquisaSatisfacao> {
...
//	"	to_char(SYSDATE,'DMMYYYYHHMISS'),        " +
	...
	"   and pesq.tp_pesquisa = 1";
	private static String sql2 = "";
	
	public static void main(String[] args) throws Exception{
		List<PesquisaSatisfacao> collectionValues = new ArrayList<PesquisaSatisfacao>();

		PesquisaSatisfacaoBatch batch = new PesquisaSatisfacaoBatch();
...
//		ResultSet rs2 = batch.executeSQL(sql2);
		...
		while(rs.next()){
			PesquisaSatisfacao at = new PesquisaSatisfacao();	
