...
@Entity
@NamedQueries( { @NamedQuery(name = "AgvTabMotivoInsucesso.findAll", query = "select o from AgvTabMotivoInsucesso o") })
@Table(name = "AGV_TAB_MOTIVO_INSUCESSO", schema = Schema.DB_OWNER)
public class AgvTabMotivoInsucesso {
	...
	public AgvTabMotivoInsucesso(){
		
	}
	
	public AgvTabMotivoInsucesso(Long codigo, String motivo) {
		this.codigo = codigo;
		this.motivo = motivo;
	}
