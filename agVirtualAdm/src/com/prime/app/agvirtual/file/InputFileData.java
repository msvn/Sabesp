package com.prime.app.agvirtual.file;
...
import com.prime.app.agvirtual.web.jsf.NoticiasBBean;
...
public class InputFileData {
    ...
    public String getSizeFormatted() {
        ...
        if (ourLength >= NoticiasBBean.MEGABYTE_LENGTH_BYTES) {
            return ourLength / NoticiasBBean.MEGABYTE_LENGTH_BYTES + " MB";
        }
        else if (ourLength >= NoticiasBBean.KILOBYTE_LENGTH_BYTES) {
            return ourLength / NoticiasBBean.KILOBYTE_LENGTH_BYTES + " KB";
        }
        else if (ourLength == 0) {
            return "0";
        }
