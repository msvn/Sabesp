package com.prime.infra.web.jsf.facelets;
 ...
 * 
 * @author $Author: miguelsv $
 * @version $Revision: 1.1 $ $Date: 2010/10/01 19:32:19 $
 */
...
public class UIRepeat extends UIComponentBase implements NamingContainer
{
   ...
   public static class Status 
   {
      ...
      public String toString()
      {
         return "UIRepeat$Status[count=" + count + ",index=" + index + ",first=" + isFirst() + ",last=" + isLast() + "]"; 
      }
   }
